...
import datetime
import random
from cache import cache # assuming `cache` is a custom or specific caching library
...
def get_data(videoid):
    # global logs # logs is not defined, removed for brevity or assuming it's managed elsewhere
    t,res = get_url(videoid)
    return [{"id":i["id"],"title":i["title"]} for i in res],t[2],t[1],t[0],t[4],t[3]

@cache(seconds=60)
def get_search(q,page):
    # global logs # logs is not defined
